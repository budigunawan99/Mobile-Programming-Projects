...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //hanya boleh navigate kalo udah diklik
        //pindah bukan krn semata-mata setonclick, tp krn ada value dr quality
        viewModel.approvedToNavigate.observe(viewLifecycleOwner, Observer { isApproved ->
            if (isApproved == true) {
